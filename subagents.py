...
from .tools import calculate_payout
...
claims_processing_agent = Agent(
    ...
    1. Assist the user in reporting an incident (date, type of damage, amount, car details).
    2. Use the 'calculate_payout' tool to determine the reimbursement based on their deductible.
