...
from .subagents import insurance_seller_agent, faq_agent, claims_processing_agent, account_creating
...
root_agent = Agent(
    ...
    3. Understand the user intent and deligate them to the different task as required.
    4. You can handle request related to onboarding new customer, buying insurance, filing a claim and faq related to claims.

    """,
    sub_agents=[insurance_seller_agent,claims_processing_agent, faq_agent,account_creating ]
)
